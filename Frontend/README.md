...
A full‑stack AI chat application with secure authentication, persistent threaded conversations, theme toggle, and a clean, responsive UI. Built with React (Vite) and Express/MongoDB, integrated with the Perplexity API for assistant responses.
